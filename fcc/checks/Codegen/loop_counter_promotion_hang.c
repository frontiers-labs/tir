...
// never advances and the loop never exits. The gcc-compiled program terminates;
// the fcc binary spins forever. Interpreting the IR before instcombine gives
// the right answer; after instcombine the interpreter loops too, localizing
// the bug to instcombine loop-carried slot promotion under nesting.
