...
// CHECK: %[[EXIT:[0-9]+]], state(%{{[0-9]+}}, %{{[0-9]+}}, %{{[0-9]+}}, %[[S:[0-9]+]], %{{[0-9]+}}) = scf.loop (%{{[0-9]+}} = %{{[0-9]+}}, state(%{{[0-9]+}} = %{{[0-9]+}}, %{{[0-9]+}} = %{{[0-9]+}}, %{{[0-9]+}} = %{{[0-9]+}}, %{{[0-9]+}} = %{{[0-9]+}}, %{{[0-9]+}} = %{{[0-9]+}})) {
// CHECK: scf.switch %[[EXIT]] args(state(%[[S]], %{{[0-9]+}})) (state(%{{[0-9]+}}, %{{[0-9]+}})) {
