...
// RUN: tir opt --pass func.func(promote-nodes,verify-deps,instcombine-nodes) -o /tmp/fcc-matmul-dynamic.base /tmp/fcc-matmul-dynamic.tir
// RUN: tir opt --pass func.func(promote-nodes,verify-deps,instcombine-nodes,affine) -o /tmp/fcc-matmul-dynamic.affine /tmp/fcc-matmul-dynamic.tir
